...
## Tell us about yourself. Experience in domain
 ...
 I have more than 10 years experience in software development and I have been working as a web developer during the last 7 years. I've started my carierr in the same year I've graduated from "Automatics, Electronics and Computer Faculty", in 2008. Along the years I switched development between accounting programs, UI web developer, back-end dev, full stack web developer and front-end web developer. In the last 2 years I worked extesively with Front-end technologies like Angular 4, React, Vue.js 2.0, Angular 6, 7, templating languages like Pug, Jade. I worked on Hybris installations and Spring  or Symfony based implementations. I like to be my own devOps when it comes to maintaining VMs or Docker machines (Mongo, MySQL, Elastic Search, Registery containers). I'm passionate about design patterns, clean code, functional, reactive programing styles and securing web apps.

## Why did you choose web development?

I choose web development because this is how I can contribute in many people's life. We are all in real need of using web apps, we services, as they ease out our day to day life. Other software development areas, though extremly important, like embeded development, are more narrowed. Compared to the other software development fields, web development is a broad domain.
...
First contact I had was with AngularJS. In 2018 I worked with Angular Js, Angular 4 and Angular 6. In 2019 with Angular 6 and 7. In 2020 I worked with Angular 7 in a project I had the most contribution on front-end side and where I implemeted some security protocols (OIDC and OAuth 2)

## Did you work before on bank projects?

I didn't but I worked on complex systems and I also made security implementations in Angular. I know security is extremly important in banking projects. 
...
I am always searching for optimizing systems I'm working on, I see when optimization is needed. I am active and engaded, either
